...
if ( ! class_exists( 'ADMINIFY_Options' ) ) {
  class ADMINIFY_Options extends ADMINIFY_Abstract {
    ...
    public function set_options( $ajax = false ) {
      ...
      $response  = ( $ajax && ! empty( $_POST['data'] ) ) ? json_decode( trim( wp_unslash( $_POST['data'] ) ), true ) : $_POST; // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- each field is sanitized individually by the framework's per-field sanitize handlers.
