...
(function ($, window, document, undefined) {
    ...
    $.fn.adminify_nav_options = function () {
        return this.each(function () {
            ...
            $window
                .on("hashchange adminify.hashchange", function () {
                    ...
                    if ($link.length) {
                        $link
                            .closest(".adminify-tab-item")
                            .addClass("adminify-tab-expanded")
                            .siblings()
                            .removeClass("adminify-tab-expanded");
        ...
        if (this.length) {
            $(document).on(
                ...
                function () {
                    ...
                    $(".adminify-page-templates")
                        .removeClass("adminify-metabox-show")
                        .addClass("adminify-metabox-hide");
                    $(".adminify-page-" + maybe_value.toLowerCase().replace(/[^a-zA-Z0-9]+/g, "-"))
                        .removeClass("adminify-metabox-hide")
                        .addClass("adminify-metabox-show");
                }
            );
        }
    };
        ...
        if (this.length) {
            $(document).on(
                ...
                function () {
                    ...
                    $(".adminify-post-formats")
                        .removeClass("adminify-metabox-show")
                        .addClass("adminify-metabox-hide");
                    $(".adminify-post-format-" + maybe_value)
                        .removeClass("adminify-metabox-hide")
                        .addClass("adminify-metabox-show");
                }
            );
    ...
    $.fn.adminify_sticky = function () {
        return this.each(function () {
            var $this = $(this),
                ...
                padding =
                    parseInt($inner.css("padding-left")) + parseInt($inner.css("padding-right")),
                offset = 32,
                scrollTop = 0,
                lastTop = 0,
                ticking = false,
            ...
            base.notificationOverlay = function () {
                if (wp.customize.notifications && wp.customize.OverlayNotification) {
                    ...
                    wp.customize.notifications.add(
                        new wp.customize.OverlayNotification("adminify_field_backup_notification", {
                            type: "default",
                            message: "&nbsp;",
                            loading: true,
                        })
            ...
            var interval = setInterval(function () {
                if ($this.is(":visible")) {
                    ...
                    if (
                        ...
                        ADMINIFY.vars.code_themes.indexOf(data_editor.theme) === -1
                    ) {
                        var $cssLink = $("<link>");
        ...
        return this.each(function () {
                ...
                activate: function (event, ui) {
                    ...
                    if ($panel.length && !$panel.data("opened")) {
                        ...
                        $.each(inputs, function (key, $input) {
                            $input
                                .on("change keyup adminify.keyup", function () {
                                    var titles = [];
            ...
            $wrapper.sortable({
                ...
                update: function (event, ui) {
                    ADMINIFY.helper.name_nested_replace(
                        $wrapper.children(".adminify-cloneable-item"),
                        field_id
                    );
            ...
            $wrapper
                .children(".adminify-cloneable-item")
                .children(".adminify-cloneable-helper")
                .on("click", ".adminify-cloneable-clone", event_clone);
            $group
                .children(".adminify-cloneable-hidden")
                .children(".adminify-cloneable-helper")
                .on("click", ".adminify-cloneable-clone", event_clone);
            ...
            $wrapper
                .children(".adminify-cloneable-item")
                .children(".adminify-cloneable-helper")
                .on("click", ".adminify-cloneable-remove", event_remove);
            $group
                .children(".adminify-cloneable-hidden")
                .children(".adminify-cloneable-helper")
                .on("click", ".adminify-cloneable-remove", event_remove);
                    ...
                    window.wp.ajax
                        ...
                        .done(function (response) {
                            ...
                            $load.on("click", "i", function (e) {
                                ...
                                ADMINIFY.vars.$icon_target
                                    .find(".adminify-icon-preview i")
                                    .removeAttr("class")
                                    .addClass(icon);
                                ADMINIFY.vars.$icon_target
                                    .find(".adminify-icon-preview")
                                    .removeClass("hidden");
                                ADMINIFY.vars.$icon_target
                                    .find(".adminify-icon-remove")
                                    .removeClass("hidden");
                                ADMINIFY.vars.$icon_target
                                    .find("input")
                                    .val(icon)
    ...
    $.fn.adminify_field_map = function () {
        return this.each(function () {
            ...
            if (!$search_input.length) {
                $search_input = $(
                    '[data-depend-id="' +
                        $this.find(".adminify--address-field").data("address-field") +
                        '"]'
                );
            }
    ...
    $.fn.adminify_field_link = function () {
        return this.each(function () {
            ...
            $edit.on("click", function (e) {
                ...
                $("#wp-link-target").prop(
                    "checked",
                    $this.find(".adminify--target").val() === "_blank"
                );
            });
    ...
    $.fn.adminify_field_media = function () {
        return this.each(function () {
            var $this = $(this),
                ...
                $library =
                    ($upload_button.data("library") && $upload_button.data("library").split(",")) ||
                    "",
                $auto_attributes = $this.hasClass("adminify-assign-field-background")
                    ? $this.closest(".adminify-field-background").find(".adminify--auto-attributes")
                    : false,
                wp_media_frame;
    ...
    $.fn.adminify_field_repeater = function () {
        return this.each(function () {
            ...
            $wrapper
                .children(".adminify-repeater-item")
                .children(".adminify-repeater-content")
                .adminify_reload_script();
            ...
            $wrapper.sortable({
                ...
                update: function (event, ui) {
                    ADMINIFY.helper.name_nested_replace(
                        $wrapper.children(".adminify-repeater-item"),
                        field_id
                    );
                    $wrapper.adminify_customizer_refresh();
            ...
            var event_clone = function (e) {
                ...
                var $this = $(this),
                    ...
                    $cloned_content = $parent
                        ...
                        .adminify_clone(),
                    $cloned_helper = $parent
                        .children(".adminify-repeater-helper")
                        .adminify_clone(true),
            ...
            $wrapper
                .children(".adminify-repeater-item")
                .children(".adminify-repeater-helper")
                .on("click", ".adminify-repeater-clone", event_clone);
            $repeater
                .children(".adminify-repeater-hidden")
                .children(".adminify-repeater-helper")
                .on("click", ".adminify-repeater-clone", event_clone);
            ...
            $wrapper
                .children(".adminify-repeater-item")
                .children(".adminify-repeater-helper")
                .on("click", ".adminify-repeater-remove", event_remove);
            $repeater
                .children(".adminify-repeater-hidden")
                .children(".adminify-repeater-helper")
                .on("click", ".adminify-repeater-remove", event_remove);
        ...
        return this.each(function () {
            ...
            $input.spinner({
                ...
                create: function (event, ui) {
                    if (data.unit) {
                        $input.after(
                            '<span class="ui-button adminify--unit">' + data.unit + "</span>"
                        );
                    }
                },
    ...
    $.fn.adminify_field_tabbed = function () {
        return this.each(function () {
            ...
            $links.on("click", function (e) {
                ...
                $link
                    .addClass("adminify-tabbed-active")
                    .siblings()
                    .removeClass("adminify-tabbed-active");
                $content.adminify_reload_script();
    ...
    $.fn.adminify_field_typography = function () {
        return this.each(function () {
            ...
            base.init = function () {
                ...
                $font_family_select
                    .on("change adminify.change", function (event) {
                ...
                if ($preview_block.length) {
                    ...
                    $this.on(
                        "change",
                        ADMINIFY.helper.debounce(function (event) {
    ...
    $.fn.adminify_field_wp_editor = function () {
        return this.each(function () {
            if (
                ...
                typeof window.tinyMCEPreInit.mceInit.adminify_wp_editor === "undefined"
            ) {
                return;
            }
            ...
            var $has_wp_editor =
                $this.find(".wp-editor-wrap").length || $this.find(".mce-container").length;
        ...
        return this.each(function () {
            ...
            $select.on("change", function () {
                ...
                if (sc_key) {
                    ...
                    window.wp.ajax
                        .post("adminify-get-shortcode-" + modal_id, {
                        ...
                        .done(function (response) {
                            ...
                            $cloned = $appended
                                .find(".adminify--repeat-shortcode")
                                .adminify_clone();
            ...
            $insert.on("click", function (e) {
                ...
                var shortcode = "";
                var serialize = $modal
                    .find(".adminify-field:not(.adminify-depend-on)")
                    .find(":input:not(.ignore)")
                    .serializeObjectADMINIFY();
                ...
                if (gutenberg_id) {
                    var content = window.adminify_gutenberg_props.attributes.hasOwnProperty(
                        "shortcode"
                    )
                        ? window.adminify_gutenberg_props.attributes.shortcode
                        : "";
            ...
            $modal.on("click", ".adminify--repeat-button", function (e) {
                ...
                ADMINIFY.helper.name_nested_replace(
                    $modal.find(".adminify--repeat-shortcode"),
                    sc_group
                );
    ...
    $.fn.adminify_color = function () {
        return this.each(function () {
            var $input = $(this),
                ...
                palette_color = window.adminify_vars.color_palette.length
                    ? window.adminify_vars.color_palette
                    : true,
                $container;
            ...
            $input.wpColorPicker({
                ...
                change: function (event, ui) {
                    ...
                    $container
                        .find(".adminify--transparent-offset")
                    ...
                    $transparent_slider.slider({
                        ...
                        create: function () {
                            ...
                            $container.on("click", ".wp-picker-default", function () {
                                var default_color = ADMINIFY.funcs.parse_color(
        ...
        return this.each(function () {
            ...
            $siblings.on("click", function () {
                ...
                if (multiple) {
                    ...
                    $sibling.find("input").prop("checked", true).trigger("change");
                    $sibling
                        .addClass("adminify--active")
                        .siblings()
                        .removeClass("adminify--active");
                }
            });
        });
    };
    ...
    $.fn.adminify_help = function () {
        return this.each(function () {
            ...
            $this.on({
                mouseenter: function () {
                    $tooltip = $('<div class="adminify-tooltip"></div>')
                        .html($this.find(".adminify-help-text").html())
                        .appendTo("body");
                    offset_left = ADMINIFY.vars.is_rtl
                        ? $this.offset().left + 24
    ...
    // Window on resize
    //
    ADMINIFY.vars.$window
        .on(
            "resize adminify.resize",
            ADMINIFY.helper.debounce(function (event) {
                var window_width =
                    navigator.userAgent.indexOf("AppleWebKit/") > -1
                        ? ADMINIFY.vars.$window.width()
                        : window.innerWidth;
    ...
    $.fn.adminify_reload_script = function (options) {
        ...
        return this.each(function () {
            ...
            if (!$this.data("inited")) {
                ...
                $this
                    .children(".adminify-field-background")
                    .find(".adminify-color")
                    .adminify_color();
                $this.children(".adminify-field-color").find(".adminify-color").adminify_color();
                $this
                    .children(".adminify-field-color_group")
                    .find(".adminify-color")
                    .adminify_color();
                $this
                    .children(".adminify-field-link_color")
                    .find(".adminify-color")
                    .adminify_color();
                $this
                    .children(".adminify-field-typography")
                    .find(".adminify-color")
                    .adminify_color();
                ...
                // Field Checkbox
                $this
                    .children(".adminify-field-checkbox")
                    .find(".adminify-checkbox")
                    .adminify_checkbox();

                // Field Siblings
                $this
                    .children(".adminify-field-button_set")
                    .find(".adminify-siblings")
                    .adminify_siblings();
                $this
                    .children(".adminify-field-image_select")
                    .find(".adminify-siblings")
                    .adminify_siblings();
                $this
                    .children(".adminify-field-palette")
                    .find(".adminify-siblings")
                    .adminify_siblings();
