...
if (!class_exists('Admin')) {
    class Admin
    {
        ...
        public function adminify_adminbar_localize_script(){
            echo $this->get_admin_bar_menu_list(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- returns an array (not HTML); the real script output is emitted safely via wp_print_inline_script_tag() on the footer hook.
        }
