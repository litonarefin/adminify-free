...
function pxlbsadminify_redirect_urls_home_replace( $redirect_url){
...
// Redirect URLs
function pxlbsadminify_update_redirect_urls()
{
    ...
    if(!empty($redirect_urls_options_settings)){
        ...
        if(!empty($redirect_urls_options_settings['new_login_url']['url'])){
            ...
            $updated_replaced_login_url = pxlbsadminify_redirect_urls_home_replace($updated_new_login_url);   // Updated Login URL
        ...
        if(!empty($redirect_urls_options_settings['login_redirects'])){
            foreach($redirect_urls_options_settings['login_redirects'] as $key=>$login_value){
                if(!empty($login_value['redirect_url']['url'])){
                    ...
                    $updated_replaced_login_url = pxlbsadminify_redirect_urls_home_replace($roles_redirect_urls); // Updated Login URL
        ...
        if(!empty($redirect_urls_options_settings['redirect_admin_url']['url'])){
            ...
            $updated_replaced_admin_url = pxlbsadminify_redirect_urls_home_replace($jltadminify_redirect_admin_url ); // Updated Login URL
        ...
        if(!empty($redirect_urls_options_settings['new_register_url']['url'])){
            ...
            $updated_replaced_admin_url = pxlbsadminify_redirect_urls_home_replace($jltadminify_new_register_url );   // Updated Login URL
...
pxlbsadminify_update_redirect_urls();
