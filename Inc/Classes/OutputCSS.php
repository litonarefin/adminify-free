...
class OutputCSS
{
	...
	public function output_scripts()
	{
		...
		if (!empty($this->options['devtools_tabs']['custom_js'])) {
			...
			echo "<script>\n";
			echo html_entity_decode($this->options['devtools_tabs']['custom_js']); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- user-supplied custom JS for inline <script> block, escaping would break output
			echo "\n</script>";
